...
class Medoo
{
    ...
    protected function selectContext($table, $join, &$columns = null, $where = null, $column_fn = null)
    {
        ...
        if (isset($table_match[1], $table_match[2])) {
            ...
            $table_query = $this->tableQuote($table_match[1]) . ' AS ' . $this->tableQuote($table_match[2]);
        } else {
    ...
    public function select($table, $join, $columns = null, $where = null)
    {
        ...
        //var_dump('kcloze 1: ', $this->selectContext($table, $join, $columns, $where));
        //var_dump('kcloze 2: ', $this->selectContext($table, $join, $columns, $where));
        $query = $this->query($this->selectContext($table, $join, $columns, $where));

        //var_dump('kcloze: ', $query);
